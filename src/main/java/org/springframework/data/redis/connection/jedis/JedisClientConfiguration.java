...
public interface JedisClientConfiguration {
	...
	interface JedisPoolingClientConfigurationBuilder {
		 ...
		 * @return {@literal this} builder.
		 */
		JedisPoolingClientConfigurationBuilder poolConfig(JedisPoolConfig poolConfig);
	...
	class DefaultJedisClientConfigurationBuilder implements JedisClientConfigurationBuilder,
		...
		private Duration readTimeout = Duration.of(Protocol.DEFAULT_TIMEOUT, ChronoUnit.MILLIS);
		private Duration connectTimeout = Duration.of(Protocol.DEFAULT_TIMEOUT, ChronoUnit.MILLIS);
		...
		/* (non-Javadoc)
		 * @see org.springframework.data.redis.connection.jedis.JedisClientConfiguration.JedisPoolingClientConfigurationBuilder#poolConfig(redis.clients.jedis.JedisPoolConfig)
		 */
		@Override
		public DefaultJedisClientConfigurationBuilder poolConfig(JedisPoolConfig poolConfig) {
